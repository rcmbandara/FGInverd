...
public class FGIN_SC extends JFrame {
	...
	public FGIN_SC() {
		...
		btnRefresh.setBounds(909, 239, 235, 77);
		...
		btnSilver.setBackground(new Color(255, 215, 0));
		btnSilver.setBounds(627, 658, 666, 83);
